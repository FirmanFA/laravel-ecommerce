                ...
                <div class="widget-content nopadding">
                  <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/edit-banner/'.$bannerDetails->id) }}" name="edit_banner" id="edit_banner" novalidate="novalidate">{{ csrf_field() }}
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            @if (!empty($bannerDetails->image))
                                <img style="width:40px;" src="{{ asset('/images/frontend_images/'.$bannerDetails->image) }}"> | <a href="{{ url('/admin/delete-banner-image/'.$bannerDetails->id) }}">Delete</a>    
                            @endif
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="{{$bannerDetails->title}}" name="title" id="title">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="checkbox" name="status"  @if ($bannerDetails->status=="1")
                            checked
                        @endif id="status" value="1">
                        </div>
                    </div>
